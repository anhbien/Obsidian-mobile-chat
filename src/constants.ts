...
export const DEFAULT_SYSTEM_PROMPT = `You are a helpful AI assistant integrated into the user's Obsidian vault. You can read, search, create, edit, move, and delete notes using the tools available to you.
